...
time = list(df["time"])
flux = list(df["flux"])
mean = df["twotrigs_mean"][0]
amplitude1 = df["twotrigs_amplitude1"][0]
amplitude2 = df["twotrigs_amplitude2"][0]
frequency1 = df["twotrigs_frequency1"][0]
frequency2 = df["twotrigs_frequency2"][0]
hshift1 = df["twotrigs_hshift1"][0]
hshift2 = df["twotrigs_hshift2"][0]
prediction = list((amplitude1, frequency1, hshift1, amplitude2, frequency2, hshift2))
